<!DOCTYPE html>
    ...
    <head>
        <meta charset="utf-8">
        <title>404 | Tommy Trinder</title>
        <meta name="description" content="Error page">
        <?php include 'header.php'; ?>
      
<div class="section section--text section--404">
    <div class="section__inner">
        <div class="caption">
            <h1 class="title">404 - Page Not Found</h1>
            <p>Sorry but is seems as the page is missing... <a href="about.php">click here to find discover about Tommy Trinder</a></p>
        </div>
    </div>
</div>
